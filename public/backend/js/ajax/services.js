            ...
            columns: [
                ...
                {field: 'created_date', title: 'Created date'},
                {
                    ...
                    template: function (row) {
                        return '\
                        <button onclick=\'show_edit_modal(' + row.id + ',"' + row.name_az + '", "' + row.name_en + '", "' + row.name_ru + '", "' + row.description_az + '", "' + row.description_en + '", "' + row.description_ru + '")\' class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
