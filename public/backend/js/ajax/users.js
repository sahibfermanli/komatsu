            ...
            columns: [
                ...
                {field: 'created_date', title: 'Created date'},
                {
                    ...
                    template: function (row) {
                        return '\
                        <button onclick=\'show_edit_modal(' + row.id + ',"' + row.name + '", "' + row.surname + '", "' + row.username + '", "' + row.email + '")\' class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
...
function show_edit_modal(id, name, surname, username, email) {
