    ...
    <ul class="menu">
        ...
        <li class="menu-item-has-children"><a href="services.html" class="dropdown-toggle">Services</a>
            <ul class="sub-menu">
                ...
                <li><a href="cargo-service.html">... Service</a></li>
        ...
        <li class="menu-item-has-children"><a href="gallery.html" class="dropdown-toggle">PRODUCTS</a>
            <ul class="sub-menu">
        ...
        <li class="menu-item-has-children"><a href="#" class="dropdown-toggle">Features</a>
            <ul class="sub-menu">
                <li><a href="request-a-quote.html">Send Email</a></li>
