                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable"
                             data-action="{{route('backend.brochures.list')}}"></div>
                        <!--end: Datatable-->
                    </div>
                </div>
                <!--end::Card-->
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div id="add_form" data-action-add="{{route("backend.brochures.store")}}"
                     data-selected-row-id="0"
                     data-action-edit="{{route("backend.brochures.update", "")}}"
                     data-action-delete="{{route("backend.brochures.destroy", "")}}">
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="image-input" id="kt_image_2">
                                <div class="image-input-wrapper" id="brochure_image_div"
                                ...
                                <label
                                    ...
                                    <input type="file" id="image" name="image" accept=".png, .jpg, .jpeg" onchange="image_preview(this, 'brochure_image_div')"/>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <a target="_blank" id="brochure_file_div" href="#">Old file</a>
                                    <input id="file" type="file" class="form-control" name="file" placeholder="File" accept=".pdf"/>
                                </div>
                                <div class="col-lg-12">
...
@section('js')
    <script src="{{asset('backend/js/ajax/brochures.js')}}"></script>
@endsection
