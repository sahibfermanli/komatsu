                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable"
                             data-action="{{route('backend.services.list')}}"></div>
                        <!--end: Datatable-->
                    </div>
                </div>
                <!--end::Card-->
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div id="add_form" data-action-add="{{route("backend.services.store")}}"
                     data-selected-row-id="0"
                     data-action-edit="{{route("backend.services.update", "")}}"
                     data-action-delete="{{route("backend.services.destroy", "")}}">
...
@section('js')
    <script src="{{asset('backend/js/ajax/services.js')}}"></script>
@endsection
