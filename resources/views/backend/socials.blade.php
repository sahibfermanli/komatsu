                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        ...
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable"
                             data-action="{{route('backend.socials.list')}}"></div>
                        <!--end: Datatable-->
                    </div>
                </div>
                <!--end::Card-->
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div id="add_form" data-action-add="{{route("backend.socials.store")}}"
                     data-selected-row-id="0"
                     data-action-edit="{{route("backend.socials.update", "")}}"
                     data-action-delete="{{route("backend.socials.destroy", "")}}">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="icon" type="text" class="form-control" placeholder="Icon"
...
@section('js')
    <script src="{{asset('backend/js/ajax/socials.js')}}"></script>
@endsection
